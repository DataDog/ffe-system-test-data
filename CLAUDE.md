...
evaluation-cases/
  test-*.json              # Evaluation scenarios, one JSON array per file
```
...
Each file is a JSON array of test case objects:
...
1. To add a new test scenario, create `evaluation-cases/test-<descriptive-name>.json` as a JSON array.
